    ...
    <>
      <header className="site-header">
        ...
        <ul className="header-nav">
          ...
          <li data-menuanchor="about" className={location.pathname === '/business' ? 'active' : ''}>
            <Link to="/business">
              <span className="count">02</span>
              <span className="anchor">业务简介</span>
            </Link>
          </li>
          <li data-menuanchor="services" className={location.pathname === '/team' ? 'active' : ''}>
            <Link to="/team">
              <span className="count">03</span>
              <span className="anchor">团队概况</span>
            </Link>
          </li>
          <li data-menuanchor="portfolio" className={location.pathname === '/share' ? 'active' : ''}>
            <Link to="/share">
              <span className="count">04</span>
              <span className="anchor">技术分享</span>
            </Link>
          </li>
          <li data-menuanchor="blog" className={location.pathname === '/fun' ? 'active' : ''}>
            <Link to="/fun">
              <span className="count">05</span>
              <span className="anchor">吃喝玩乐</span>
            </Link>
          </li>
          <li data-menuanchor="contact" className={location.pathname === '/join' ? 'active' : ''}>
            <Link to="/join">
