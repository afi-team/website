          ...
          <div className="display-center">
            <div className="section-title-1">
              <div className="container">
                <h2>一个小而美的全能团队</h2>
                <p><span className={style.logoFamily}>AFI</span> 团队目前共有 1<del>2</del>3 人，其中用户产品经理 1 人、数据产品经理 1 人、大数据工程师 1 人，其余均为全栈工程师 / 前端工程师 / Node.js 工程师，另有前端架构师、设计师、技术支持等角色默契配合。</p>
